...
static StorageSpiflashDevice_t getDeviceType(void)
{
  ...
  BTL_DEBUG_PRINTLN("Get device type...");
...
{
//  BTL_DEBUG_PRINTLN("Get device info...");
  waitUntilNotBusy();
...
int32_t storage_init(void)
{
  ...
  BTL_DEBUG_PRINTLN("Storage Init...");
